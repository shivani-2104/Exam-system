<html>
    ...
    <div >
        ...
        <tr> <td style="font-size: 25">Q.5 :  Can Private method be inherited or not  <br><br></td></tr>
        <tr> <td>1: &ensp;Yes<input type="checkbox" value="Yes" name="n5"> </td></tr>
        <tr> <td>2: &ensp;No<input type="checkbox" value="No" name="n5"> </td></tr>
        <tr> <td>3: &ensp;Depend on situation<input type="checkbox" value="Depend on situation" name="n5"> </td></tr>
        <tr> <td>4: &ensp;May be<input type="checkbox" value="May be" name="n5"> </td></tr>
    ...
    <%String  s4[]=request.getParameterValues("n4");%>
        ...
        <tr><td><input type="submit" value="Previous" name="Submit" formaction="java5.jsp" class="bbutton" style="margin-top:30px"> 
                <input type="submit" value="Next" name="Submit" formaction="java6.jsp" style="margin-left:500px;margin-top: 30px" class="bbutton" > </td></tr>
